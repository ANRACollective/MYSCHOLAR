...
// Wave 16: from wave16.js (Corporate scholarships, career pages, internship cities)
// Created: 2026-05-15 — 20 pages across 5 pillars
try {
  const w16 = require('./wave16.js');
  KEYWORDS.push(...w16);
  console.log('  Wave 16: ' + w16.length + ' keywords');
} catch(e) {
  console.log('  Wave 16: not found, skipping');
}

// Wave 17: from wave17.js (Academic/professional careers, kerjaya discovery, East Malaysia locations, niche scholarships, telco/defence sectors)
// Created: 2026-06-02 — 20 pages across 5 pillars
try {
  const w17 = require('./wave17.js');
  KEYWORDS.push(...w17);
  console.log('  Wave 17: ' + w17.length + ' keywords');
} catch(e) {
  console.log('  Wave 17: not found, skipping');
}
